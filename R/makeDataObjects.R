...
usethis::use_data(speciesDistribution, compress = "xz", internal = TRUE, overwrite = T)
...
usethis::use_data(efaecalis, fprausnitzii, rintestinalis, ljohnsonii, bobeum, overwrite = T)
